...
This prototype uses browser local storage for demonstration state. It does not implement production authentication, encrypted storage, append-only events, rights leases, sockets, media, settlement, or legal advice.
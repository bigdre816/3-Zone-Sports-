...
- `TZ_ENV` must be `demo`.
- `TZ_ALLOWED_ORIGINS` must include `https://3zonesports.com`, `https://www.3zonesports.com`, `https://app.3zonesports.com`, `https://threezonesport.lovable.app`, and `https://id-preview--e1c1692a-52f7-4996-b306-bb996baa123b.lovable.app`.
- `TZ_PUBLIC_APP_URL` must be `https://app.3zonesports.com`.

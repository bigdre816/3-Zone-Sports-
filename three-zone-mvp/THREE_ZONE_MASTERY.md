...
| TZ_ALLOWED_ORIGINS | derived from HTTP | Exact CORS and WS Origin. Production includes marketing, Render, and app.3zonesports.com. |
...
| TZ_PUBLIC_APP_URL | empty | Member portal origin (`https://app.3zonesports.com` in production) |

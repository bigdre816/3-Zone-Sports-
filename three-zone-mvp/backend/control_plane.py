...
SITE_ROUTES = [
    ...
    {"method": "GET", "path": "/api/public/live", "tier": "public",
     "purpose": "Unsigned live-event catalog with safe display fields"},
    {"method": "GET", "path": "/api/public/schedules", "tier": "public",
     "purpose": "Unsigned schedule catalog with safe display fields"},
    {"method": "GET", "path": "/api/public/archives", "tier": "public",
     "purpose": "Unsigned archive catalog with safe display fields"},

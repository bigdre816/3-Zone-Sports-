...
SITE_ROUTES = [
    ...
    {"method": "GET", "path": "/api/ops/sports-check/assets", "tier": "worker",
    ...
    {"method": "GET", "path": "/api/member/sports", "tier": "member",
     "purpose": "Member-only My Teams / live / upcoming / finals sports snapshot"},
    {"method": "GET", "path": "/api/member/sports/live", "tier": "member",
     "purpose": "In-progress games for followed teams (not a watch lease)"},
    {"method": "GET", "path": "/api/member/sports/upcoming", "tier": "member",
     "purpose": "Upcoming games for followed teams"},
    {"method": "GET", "path": "/api/member/sports/finals", "tier": "member",
     "purpose": "Recent finals for followed teams"},
    {"method": "GET", "path": "/api/member/sports/browse", "tier": "member",
     "purpose": "Nested league/team browse of professional scores"},
    {"method": "GET", "path": "/api/member/sports/teams/{id}", "tier": "member",
     "purpose": "Member team scoreboard page"},
    {"method": "GET", "path": "/api/member/scores", "tier": "member",
     "purpose": "Alias of /api/member/sports"},
    {"method": "GET", "path": "/api/member/scores/upcoming", "tier": "member",
     "purpose": "Alias of /api/member/sports/upcoming"},
    {"method": "GET", "path": "/api/member/scores/finals", "tier": "member",
     "purpose": "Alias of /api/member/sports/finals"},
    {"method": "GET", "path": "/api/member/scores/teams/{id}", "tier": "member",
     "purpose": "Alias of /api/member/sports/teams/{id}"},
    {"method": "GET", "path": "/api/member/city/places", "tier": "member",
     "purpose": "Canonical City places (Getting There destinations)"},
    {"method": "GET", "path": "/api/member/city/places/{city_place_id}", "tier": "member",
     "purpose": "One City place by city_place_id"},
    {"method": "POST", "path": "/api/member/city/routes/plan", "tier": "member",
     "purpose": "Getting There traffic-aware drive plan against city_place_id"},
    {"method": "POST", "path": "/api/member/getting-there", "tier": "member",
     "purpose": "Lovable Member Gateway alias of /api/member/city/routes/plan"},
    {"method": "POST", "path": "/api/member/route-plan", "tier": "member",
     "purpose": "Lovable Member Gateway fallback alias of /api/member/city/routes/plan"},
    {"method": "POST", "path": "/api/member/city/directions-url", "tier": "member",
     "purpose": "External maps directions URL helper (does not emit navigation.started)"},
    {"method": "GET", "path": "/api/member/city/navigation/capability", "tier": "member",
     "purpose": "Native navigation capability stub (Milestone B; native=false)"},
    ...
    {"method": "POST", "path": "/api/network/posts", "tier": "member",
     "purpose": "Publish a sports photo, clip, or YouTube post"},
    {"method": "POST", "path": "/api/network/review/posts/{id}", "tier": "worker",
     "purpose": "Restrict, remove, or restore a Huddle post"},
    {"method": "GET", "path": "/api/member/teams", "tier": "member",
     "purpose": "Teams the member follows plus catalog to add"},
